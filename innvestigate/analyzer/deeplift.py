...
import innvestigate.analyzer.network_base
import innvestigate.analyzer.reverse_base
from . import base
...
class DeepLIFT(ReverseAnalyzerBase):
    ...
    def _create_back_analysis(self, model, *args, **kwargs):
        ...
        tmp = super(DeepLIFT, self)._create_back_analysis(
            model, *args, **kwargs)
...
class DeepLIFTWrapper(AnalyzerNetworkBase):
