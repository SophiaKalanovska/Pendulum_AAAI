...
class PatternNet(base.OneEpochTrainerMixin, ReverseAnalyzerBase):
    """PatternNet analyzer.
    ...
    def _create_back_analysis(self, *args, **kwargs):
        ...
        return super(PatternNet, self)._create_back_analysis(*args, **kwargs)
